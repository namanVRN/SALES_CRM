...
function NbdIn() {
  ...
  const cards = [
    ...
    //   icon: "bi-bookmark-check-fill",  // ✅ Changed icon
  ...
  return (
    <Layout breadcrumbs={[{ name: "CPCannotContact", path: "/nbd-in" }]}>
      <div className="nbdin-container">
        ...
        {/* Info Footer */}
        {/* <div className="nbdin-footer">
          <div className="nbdin-footer-tip">
            <i className="bi bi-info-circle-fill"></i>
            <span>Follow the numbered steps to complete the NBD IN workflow</span>
          </div>
        </div> */}
      </div>
    </Layout>
